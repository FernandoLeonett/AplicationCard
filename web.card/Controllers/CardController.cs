...
namespace app_card.Controllers
{
    ...
    public class CardController : Controller
    {
        ...
        public CardController(IRepositoryFactory repositoryFactory, IFlashMessage flashMessage, IConfiguration configuration)
        {
        ...
        public ActionResult Index()
        {
            ...
            IEnumerable<Card> cards = _repositoryFactory.GetCardRepository().GetAll(DataSource.ChristmasCards,DataSource.BIRTHDAYCARDS);
