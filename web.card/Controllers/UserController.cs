...
namespace app_card.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(IFlashMessage flashMessage, IConfiguration configuration)
        {
        ...
        public ActionResult Login()
        {
            ...
            {
                ViewBag.conexion=_configuration.GetConnectionString(DataSource.BIRTHDAYCARDS.ToString());
                return View();
            }
            else
            {
