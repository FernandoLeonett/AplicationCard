...
namespace app_card.Repositories
{
    ...
    public class CardRepository : ICardRepository
    {
        ...
        public CardRepository(IConfiguration confi)
        {
        ...
        public IEnumerable<Card> GetAll(DataSource con1, DataSource con2) 
        {
            var cards = new List<Card>();

            using var connection1 = new SqlConnection(_configuration.GetConnectionString(con1.ToString()));
            using var connection2 = new SqlConnection(_configuration.GetConnectionString(con2.ToString()));
